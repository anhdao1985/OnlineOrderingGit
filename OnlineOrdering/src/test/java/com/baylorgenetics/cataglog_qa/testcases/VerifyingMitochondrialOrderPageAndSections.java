...
// Initiate gettheOrderButtonDetailsP icon as the allPanels class
		...
		driver.get("https://orders-qa.baylorgenetics.com/create?test=2055");
		Thread.sleep(3000);
		...
		/*
		 * // Verifying the Test number and name on the Order page if
		 * (driver.findElement(By.xpath(
		 * "//div[@id='root']/div/div/div[1]/div[2]/div/div[3]")).getText()
		 * .equalsIgnoreCase("2055Comprehensive mtDNA Analysis by Massively Parallel Sequencing (MitoNGS℠)"
		 * )) { System.out.
		 * println("Order Page Contains 2055 | Comprehensive mtDNA Analysis by Massively Parallel Sequencing (MitoNGS℠) Pass"
		 * ); } else { System.out.
		 * println("Order Page Contains 2055 | Comprehensive mtDNA Analysis by Massively Parallel Sequencing (MitoNGS℠) Fail"
		 * ); }
		 */
