  ...
  public void logInChrome() throws InterruptedException  {
	 ...
	 driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
	   ...
	   //Click Backpage
	    ...
	    //Expand the Primary panel
	    driver.findElement(By.xpath("//div[@id='root']/div/div[1]/div[2]/div/div[3]/div[10]/button/span[1]")).click();
	    Thread.sleep(1000);
	    
	    //Expand the Primary panel
	    driver.findElement(By.xpath("//div[@id='root']/div/div[1]/div[2]/div/div[3]/div[11]/button/span[1]")).click();
	    Thread.sleep(1000);
